 ...
 * This file demonstrates how to integrate Crestraft with a web frontend
 */

// For React/Vue/Angular applications
export class CrestraftClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CrestraftClient(provider, contractAddress);
